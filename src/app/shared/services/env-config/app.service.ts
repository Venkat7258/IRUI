...
export class AppService {
  ...
  private viewHeaderMenu = new BehaviorSubject<boolean>(false);
  showHeaderMenu = this.viewHeaderMenu.asObservable();
  ...
  setSideMenuShow(value: boolean) {
    this.viewHeaderMenu.next(value);
  }
